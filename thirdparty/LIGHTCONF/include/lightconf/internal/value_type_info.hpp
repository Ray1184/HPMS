...
//
    ...
    struct value_type_info<value>
    {
        ...
        static const value& extract_value(const value& val)
        { return val; }

        static value create_value(const value& val)
        { return val; }
    };
...
//
    ...
    {
        static bool can_convert_from(const value& val)
        { return val.type() == value_type::string_type; }

        static const char* extract_value(const value& val)
        { return val.string_value().c_str(); }

        static value create_value(const char* x)
...
//
    ...
    {
        static bool can_convert_from(const value& val)
        { return val.type() == value_type::vector_type; }
