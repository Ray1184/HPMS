...
/*! @brief Returns the `GLWindow` of the specified window.
 *
 *  @return The `GLWindow` of the specified window, or `None` if an
 *  [error](@ref error_handling) occurred.
 *
 *  @thread_safety This function may be called from any thread.  Access is not
 *  synchronized.
 ...
 *  @ingroup native
 */
GLFWAPI GLWindow glfwGetX11Window(GLFWwindow* window);
#endif
